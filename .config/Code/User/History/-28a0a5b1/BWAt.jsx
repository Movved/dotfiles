        ...
        <>
            <div className=' relative bg-[#B33791] w-80 h-100 rounded-md flex justify-center '>
                <div id='Affich' className='mt-30'>
                    <p id='timer' className='font-sky-600 text-center mb-10'>25:00</p>
                    
                </div>
                <div className='absolute bottom-[10px]' >
                    <input type="number" name="time" id="time" placeholder='minutes'/>
                    <button id="startBtn" onClick={startFct} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                    Start</button>
                    <button id="stopBtn" className="m-1 bg-[#521C0D] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                    Stop</button>
